...
import SysReqJava from '@site/docs/imported/sys_req/_sys_req_java.mdx';
import SysReqMaven from '@site/docs/imported/sys_req/_sys_req_maven.mdx';
import SysReqEwonFw from '@site/docs/imported/sys_req/_sys_req_ewon_fw.mdx';
